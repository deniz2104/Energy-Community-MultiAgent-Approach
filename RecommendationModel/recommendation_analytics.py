...
class RecommendationAnalytics:
    """Analytics and percentage calculations for recommendations."""
    ...
    def make_percentage_of_overall_recommendations(self, house_with_appliances, appliance_thresholds):
        number_of_recommendation = self._recommendation_model.give_recommendation_based_on_sigmoid_threshold(house_with_appliances, appliance_thresholds)
    ...
    def make_dictionary_of_recommendations_percentages_per_hour(self, house_with_appliances, appliance_thresholds):
    ...
    def make_percentage_of_recommendations_per_appliance(self,house_with_appliances, appliance_thresholds):
