...
class HousePreprocessingData:
    ...
    def round_remained_anomalies(self, house: House) -> None:
    ...
    def remove_houses_having_zero_for_a_period_of_time(self, house: House, is_appliance: Optional[bool] = None) -> int:
        first_period: Optional[str] = None
        last_period: Optional[str] = None
        time_stamps: set[tuple[str, str]] = set()
