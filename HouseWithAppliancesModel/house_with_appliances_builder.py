...
class HouseWithAppliancesBuilder:
    ...
    def _open_csv_file(self, csv_path: str) -> list[tuple[int, str, str, float]]:
    ...
    def export_to_csv(self, appliances: list[HouseWithAppliancesConsumption], file_path: str) -> None:
    ...
    def build(self, csv_path: str) -> list[HouseWithAppliancesConsumption]:
        houses_with_appliances_consumption: dict[int, HouseWithAppliancesConsumption] = {}
