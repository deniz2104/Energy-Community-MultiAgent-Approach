...
class RecommendationModel:
    ...
    ##FIXME: rescriere nume functie, nu are sens
    ...
    def make_percentage_of_recommendations_per_appliance(self,house_with_appliances, appliance_thresholds):
        number_of_recommendations = self.see_how_many_recommendations_are_going_to_be_made(house_with_appliances, appliance_thresholds)
