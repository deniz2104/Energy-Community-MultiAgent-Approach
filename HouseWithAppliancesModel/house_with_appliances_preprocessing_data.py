...
class HouseWithAppliancesPreprocessingData:
    ...
    def _eliminate_days_after_a_year(self,house_with_appliances,house):
    ...
    def _count_zeros_in_consumption(self,house_with_appliances):
    ...
    def _eliminate_appliances_with_lot_of_zeros_consumption(self,house_with_appliances):
    ...
    def _eliminate_anomalies_in_my_data(self,house_with_appliances):
        new_consumption = {}
    ...
    def _eliminate_appliance_with_five_days_of_no_consumption(self,house_with_appliances):
        new_consumption = {}
    ...
    def remove_appliances_with_zero_data(self, houses_with_appliances):
        for house in houses_with_appliances:
            self._eliminate_appliances_with_lot_of_zeros_consumption(house)

    def eliminate_anomalies_in_appliances(self, houses_with_appliances):
        for house in houses_with_appliances:
            self._eliminate_anomalies_in_my_data(house)

    def eliminate_appliances_with_five_days_of_no_consumption(self, houses_with_appliances):
        for house in houses_with_appliances:
            self._eliminate_appliance_with_five_days_of_no_consumption(house)

    def matching_timestamps_between_appliance_and_house(self, house_with_appliances, consumption_houses):
