...
class PowerEstimatedPlotter(BasePlotterInterface):
    ...
    def _plot_power_over_time_range_for_a_number_of_panels(self, power_house, time_stamp_1, time_stamp_2):
        return self.plot_over_time_range(power_house, time_stamp_1, time_stamp_2)

    def _make_annotations(self, self_consumption=None, self_sufficiency=None):
        annotations = []
    ...
    def _update_layout(self, fig,annotations):
