...
class SelfSufficiencyBuilder():
    ...
    def build_self_sufficiency(self, houses,power_estimated_houses):
        ...
        for house in houses:
            ...
            self_sufficiency_house[house.house_id].consumption = house.consumption
            self_sufficiency_house[house.house_id].power_estimated = power_dict[house.house_id].power_estimated
