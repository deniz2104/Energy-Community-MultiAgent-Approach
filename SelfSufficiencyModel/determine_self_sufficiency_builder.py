...
class SelfSufficiencyBuilder():
    ...
    def build_self_sufficiency(self, houses: list[House], power_estimated_houses: list[PowerEstimator],specified_value_range: Optional[int] = None) -> list[SelfSufficiency]:
        ...
        for house in houses:
            ...
            self_sufficiency_houses[house.house_id].determine_self_sufficiency_over_time(specified_value_range)
